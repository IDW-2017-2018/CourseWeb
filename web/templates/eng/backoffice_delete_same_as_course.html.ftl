...
<div class="tablecontainer">
    ...
    <table class="tableresult">
        ...
        <tr class="trresult">
            ...
            <th class="thresultfront" colspan="7"><h1 class="title">LIST SAME AS COURSES</h1></th>
        ...
        <tr class="trresult-list">
            ...
            <td class="tdresult-list"><a href="backofficeeditcourse?id=${id}&lang=${lang}&item=${item.id}&elimina_corso_mutuato_action=true&action=delete_check" class="linkresultmod">DELETE</a></td>
