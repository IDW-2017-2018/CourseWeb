...
<div class="helper">
    ...
    <div class="helpertext">
        ...
        <p><b>DELETE A RELATIONSHIP WITH A PROPAEDEUTIC COURSE</b></p>
        <p>In the current page, the administrator can perform the following operations</p>
        <ul>
          <li>click in link <b>DELETE</b> alongside a propaedeutic course's relationship to select it and go in deletion's confirmation page</li>
        </ul>
...
<div class="tablecontainer">
    ...
    <table class="tableresult">
        ...
        <tr class="trresult">
            ...
            <th class="thresultfront" colspan="7"><h1 class="title">LIST PROPAEDEUTIC COURSES</h1></th>
        ...
        <tr class="trresult-list">
            ...
            <td class="tdresult-list"><a href="backofficeeditcourse?id=${id}&lang=${lang}&item=${item.id}&name=elimina_corso_propedeutico_action&action=delete_check" class="linkresultmod">DELETE</a></td>   
        </tr>
