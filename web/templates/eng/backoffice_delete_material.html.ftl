...
<div class="tablecontainer">
    ...
    <table class="tableresult">
        ...
        <tr class="trresult-list">
            ...
            <td class="tdresult-list"><a href="backofficeeditcourse?id=${id}&lang=${lang}&item=${item.id}&elimina_materiale_action=true&action=delete_check" class="linkresultmod">DELETE</a></td>
