...
<body>
    ...
    <ul class="lang_bar">
            ...
            <li><a href="login?lang=ita">ITALIAN</a></li>
            <li><a href="login?lang=eng">ENGLISH</a></li>
    ...
    <div class="footer">
        ...
        <ul class="footer_link_container">
            ...
            <li><a class="footer_link_item" href="contacts">CONTACTS</a></li>
            <li><a class="footer_link_item" href="about">ABOUT</a></li>
