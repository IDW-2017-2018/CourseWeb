...
<div class="helper">
    ...
    <div class="helpertext">
        ...
        <p><b>AGGIUNTA NUOVA RELAZIONE CON MODULO</b></p>
        <p>Nella pagina corrente l'utente amministratore pu&ograve; eseguire le seguenti operazioni</p>
        <ul>
        <li>clicca sul bottone <b>AGGIUNGI</b> per aggiungere una nuova relazione con un modulo esistente</li>
        </ul>
        <hr>
        ...
        <li>il campo <b>MODULO</b> permette di scegliere il modulo da relazionare con il corso corrente, nella select appariranno solo i corsi che non possiedono gi&agrave; una relazione con il corso corrente e che appartengono allo stesso corso di laurea del corso corrente</li>
        </ul>
