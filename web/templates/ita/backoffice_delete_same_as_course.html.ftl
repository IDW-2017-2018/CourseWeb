...
<div class="helper">
    ...
    <div class="helpertext">
        ...
        <p><b>ELIMINA RELAZIONE CON CORSO MUTUATO</b></p>
        <p>Nella pagina corrente l'utente amministratore pu&ograve; eseguire le seguenti operazioni</p>
        <ul>
          <li>clicca sul link <b>ELIMINA</b> relativo ad una relazione con corso mutuato per selezionarla e passare alla pagina di conferma eliminazione relativa alla relazione con corso mututato selezionata </li>
        </ul>
...
<div class="tablecontainer">
    ...
    <table class="tableresult">
        ...
        <tr class="trresult">
            ...
            <th class="thresultfront" colspan="7"><h1 class="title">CORSI MUTUATI ASSOCIATI</h1></th>
        ...
        <tr class="trresult-list">
            ...
            <td class="tdresult-list"><a href="backofficeeditcourse?id=${id}&lang=${lang}&item=${item.id}&name=elimina_corso_mutuato_action&action=delete_check" class="linkresultmod">ELIMINA</a></td>
