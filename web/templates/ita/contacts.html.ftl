...
<div class="card">
  <img class="card-img" src="images/contacts_imgs/card-img.png">
  <div class="card-text-box">    
      <h1>Valentino<br> Di Giosaffatte</h1>
      <p class="card-title">Co-Fondatore</p>
      <p class="card-text"><em>Universit&agrave; degli Studi dell'Aquila</em></p>
