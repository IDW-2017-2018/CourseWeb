...
<div class="helper">
    ...
    <div class="helpertext">
        ...
        <p><b>ELIMINA RELAZIONE CON CORSO PROPEDEUTICO</b></p>
        <p>Nella pagina corrente l'utente amministratore pu&ograve; eseguire le seguenti operazioni</p>
        <ul>
          <li>clicca sul link <b>ELIMINA</b> relativo ad una relazione con corso propedeutico per selezionarla e passare alla pagina di conferma eliminazione relativa alla relazione con corso propedeutico selezionata </li>
        </ul>
