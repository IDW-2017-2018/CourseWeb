...
public interface CourseWebDataLayer extends DataLayer {
    ...
    void deleteCorsiModuli(int corso_integrato_key, int modulo_key) throws DataLayerException;
    ...
    void deleteCorsiCorsiLaurea(int corso_key, int corso_laurea_key) throws DataLayerException;
    ...
    void deleteMateriale(int materiale_key) throws DataLayerException;
    
    List<Corso> retrieveCorsoLangs(int corso_key) throws DataLayerException;
